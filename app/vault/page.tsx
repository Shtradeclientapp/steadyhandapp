    ...
    <div style={{ background:'#C8D5D2', minHeight:'100vh', fontFamily:'sans-serif' }}>
      ...
      <div style={{ background:'white', borderBottom:'1px solid rgba(28,43,50,0.08)', padding:'12px 24px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'12px', flexWrap:'wrap' }}>
        ...
        <div style={{ display:'flex', gap:'8px', alignItems:'center' }}>
              ...
              {/* Compliance archive notice */}
              <div style={{ background:'#E8F4F0', border:'1.5px solid #2E7D60', borderRadius:'10px', padding:'12px 16px', marginBottom:'16px' }}>
                <p style={{ fontSize:'10px', fontWeight:700, color:'#2E7D60', margin:'0 0 3px', textTransform:'uppercase' as const, letterSpacing:'0.5px' }}>Compliance archive</p>
                <p style={{ fontSize:'11px', color:'#1C2B32', lineHeight:'1.6', margin:0 }}>Every document in this archive is timestamped, IP-logged and tamper-evident. Scope agreements, milestone records, warranty certificates and audit trails generated by Steadyhand are admissible as legal evidence in proceedings before the State Administrative Tribunal (WA), NCAT (NSW), VCAT (VIC) and the Insurance Commission of WA.</p>
              </div>
