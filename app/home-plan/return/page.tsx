...
export default function HomePlanReturnPage() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#C8D5D2', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'sans-serif', padding:'24px' }}>
      <div style={{ background:'#E8F0EE', borderRadius:'20px', padding:'40px 36px', maxWidth:'480px', width:'100%', textAlign:'center' as const, boxShadow:'0 16px 48px rgba(28,43,50,0.12)' }}>
        {status === 'loading' && (
          <>
            <div style={{ width:'48px', height:'48px', border:'3px solid rgba(28,43,50,0.1)', borderTop:'3px solid #2E7D60', borderRadius:'50%', margin:'0 auto 24px', animation:'spin 0.8s linear infinite' }} />
        ...
        {status === 'open' && (
          <>
            ...
            <a href="/home-plan" style={{ fontSize:'13px', color:'#2E6A8F' }}>← Back to plans</a>
          </>
        )}
        {status === 'error' && (
          <>
