    ...
    <div style={{ minHeight:'100vh', background:'#C8D5D2', fontFamily:'sans-serif' }}>
      ...
      <div style={{ background:'#1C2B32', padding:'48px 0', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ maxWidth:'900px', margin:'0 auto', padding:'0 48px', position:'relative', zIndex:1 }}>
          ...
          <h1 style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'36px', color:'rgba(216,228,225,0.9)', letterSpacing:'2px', marginBottom:'6px' }}>STEADYHAND</h1>
      ...
      <div style={{ maxWidth:'900px', margin:'0 auto', padding:'40px 48px' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:'16px', marginBottom:'32px' }}>
          {[
            ...
            <div key={s.label} style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'12px', padding:'22px' }}>
              ...
              <p style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'36px', color:'#1C2B32', letterSpacing:'1px' }}>{s.value}</p>
            </div>
          ))}
        </div>
        ...
        <div style={{ background:'#2E7D60', borderRadius:'14px', padding:'28px 32px', display:'flex', alignItems:'center', justifyContent:'space-between', gap:'20px', flexWrap:'wrap' }}>
          <div>
            <h2 style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'20px', color:'white', letterSpacing:'1px', marginBottom:'4px' }}>START A NEW REQUEST</h2>
            <p style={{ fontSize:'13px', color:'rgba(255,255,255,0.7)' }}>Define your job, get AI-matched tradies, set the scope.</p>
          </div>
          <a href="/request" style={{ background:'white', color:'#2E7D60', padding:'13px 28px', borderRadius:'10px', fontSize:'14px', fontWeight:'600', textDecoration:'none', fontFamily:'var(--font-aboreto), sans-serif', letterSpacing:'1px', whiteSpace:'nowrap' }}>
            NEW REQUEST
          </a>
        </div>
      </div>
