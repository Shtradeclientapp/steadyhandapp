  ...
  return (
    <div style={{ minHeight:'100vh', background:'#C8D5D2', fontFamily:'sans-serif' }}>
      ...
      <div style={{ background:'#0A0A0A', padding:'40px 24px 32px' }}><div style={{ maxWidth:'760px', margin:'0 auto' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'10px' }}><span style={{ fontSize:'32px' }}>❄️</span><h1 style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'clamp(22px,5vw,32px)', color:'rgba(216,228,225,0.92)', letterSpacing:'2px', margin:0 }}>AIR CONDITIONING COSTS IN WA</h1></div>
      ...
      <div style={{ maxWidth:'760px', margin:'0 auto', padding:'32px 24px' }}>
        <div style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'14px', overflow:'hidden', marginBottom:'20px' }}>
          <div style={{ background:'rgba(46,106,143,0.08)', borderBottom:'1px solid rgba(46,106,143,0.2)', padding:'14px 20px' }}><p style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'12px', color:'#2E6A8F', letterSpacing:'0.5px', margin:0 }}>TYPICAL PRICE RANGES — PERTH METRO 2025</p></div>
        ...
        <div style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'14px', overflow:'hidden', marginBottom:'20px' }}>
          ...
          <div style={{ padding:'20px', display:'flex', flexDirection:'column' as const, gap:'14px' }}>
            {[
              { factor:'Sizing for Perth\'s climate — the most critical decision', detail:'Perth has extreme summer heat — days above 40°C are not unusual in January and February — combined with cool winters. This temperature range (often -5°C to +45°C effective temperature including radiant heat) is larger than most of Australia, and it drives hard on undersized air conditioners. A 2.5kW unit that might cool a bedroom in Sydney will struggle in a west-facing Perth bedroom in summer. Always ask for a heat load calculation for Perth conditions before accepting a sizing recommendation.' },
              { factor:'Installation complexity in older homes', detail:'Perth\'s post-war housing stock — brick and tile homes built from the 1950s to 1980s in suburbs like Balga, Mirrabooka, Westminster, Gosnells — often have limited roof space, no internal wall cavities suitable for pipe runs, and aging switchboards that need circuit additions. Installation in these homes costs more than in a modern brick veneer home with accessible roof space. Always get a site inspection before accepting a quote.' },
              { factor:'Coastal corrosion — the hidden warranty issue', detail:'Standard split system units installed within 1–2km of the coast in Perth will corrode faster than their warranty period unless specifically protected. Ask about "coastal" or "marine" grade units and fin coating treatments. This is particularly relevant for properties in Cottesloe, Swanbourne, Scarborough, City Beach, Trigg, Hillarys and South Fremantle. A corroded outdoor unit three years into a five-year warranty is a common dispute.' },
              { factor:'Brand and efficiency — the long-term cost', detail:'Perth homes run air conditioning heavily — 4–5 months of cooling plus heating year-round is common. A 1-star energy rating difference in a 5kW unit translates to roughly $150–$250 per year in electricity in Perth\'s hot climate. Over a 10-year lifespan, a higher-efficiency unit (Daikin, Mitsubishi Heavy, Fujitsu premium range) can save $1,500–$2,500 in electricity versus a budget brand, even accounting for higher purchase price.' },
            ].map(f => (
        ...
        <div style={{ background:'rgba(46,106,143,0.06)', border:'1px solid rgba(46,106,143,0.2)', borderRadius:'12px', padding:'18px 20px', marginBottom:'20px' }}>
          ...
          <p style={{ fontSize:'13px', color:'#4A5E64', lineHeight:'1.7', margin:'0 0 10px' }}>Air conditioning installation in WA requires both an ARCtick refrigerant handling licence (from the Australian Refrigeration Council) for the refrigerant work, and a WA Electrical Contractor Licence for the electrical connection. The same person may hold both, or two separate contractors may be involved. Always confirm both licences are current.</p>
          <p style={{ fontSize:'13px', color:'#4A5E64', lineHeight:'1.7', margin:0 }}>A Certificate of Electrical Compliance must be issued for the electrical work. Verify the electrician's licence at energysafety.wa.gov.au and the refrigerant licence at arctick.com.au.</p>
        </div>
        <div style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'14px', overflow:'hidden', marginBottom:'20px' }}>
          ...
          <div style={{ padding:'16px 20px' }}>
            {['Can you provide a heat load calculation for Perth conditions for this room?','Is this unit rated for coastal/marine environments (if near the coast)?','What is the energy star rating and estimated annual running cost in Perth?','Does my switchboard need a new circuit — is this included in the quote?','Do you hold both an ARCtick licence and an Electrical Contractor Licence?','Will a Certificate of Electrical Compliance be issued?','What warranty do you offer on workmanship, separate from the manufacturer warranty?','What is the pipe run length and are there any access issues that affect price?'].map((q,i) => (
        ...
        <div style={{ background:'rgba(212,82,42,0.05)', border:'1px solid rgba(212,82,42,0.2)', borderRadius:'12px', padding:'18px 20px', marginBottom:'28px' }}>
          ...
          {['No site visit before quoting — sizing without seeing the space is guesswork','Standard unit quoted for a coastal property without corrosion protection','No mention of switchboard assessment','Unlicensed refrigerant handling — ARCtick licence is mandatory','Quote that bundles everything without separating unit cost from installation labour'].map((f,i) => (
        ...
        <div style={{ background:'#0A0A0A', borderRadius:'14px', padding:'28px', textAlign:'center' as const }}>
          ...
          <p style={{ fontSize:'13px', color:'rgba(216,228,225,0.4)', lineHeight:'1.7', margin:'0 0 18px', maxWidth:'440px', marginLeft:'auto', marginRight:'auto' }}>Post your air conditioning job on Steadyhand — scope includes unit specification, pipe run details and compliance certificates so there are no surprises.</p>
