...
export const metadata = { title:'Bathroom Renovation Cost Guide WA 2025 — Perth Pricing | Steadyhand', description:'How much does a bathroom renovation cost in Perth? 2025 pricing guide covering tiling, plumbing, electrical and full renovation costs with WA-specific factors.' }
    ...
    <div style={{ minHeight:'100vh', background:'#C8D5D2', fontFamily:'sans-serif' }}>
      ...
      <div style={{ background:'#0A0A0A', padding:'40px 24px 32px' }}>
        <div style={{ maxWidth:'760px', margin:'0 auto' }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'10px' }}><span style={{ fontSize:'32px' }}>🚿</span><h1 style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'clamp(22px,5vw,32px)', color:'rgba(216,228,225,0.92)', letterSpacing:'2px', margin:0 }}>BATHROOM RENOVATION COSTS IN WA</h1></div>
      ...
      <div style={{ maxWidth:'760px', margin:'0 auto', padding:'32px 24px' }}>
        ...
        <div style={{ background:'rgba(107,79,168,0.06)', border:'1px solid rgba(107,79,168,0.2)', borderRadius:'12px', padding:'18px 20px', marginBottom:'20px' }}>
          ...
          <p style={{ fontSize:'13px', color:'#4A5E64', lineHeight:'1.7', margin:0 }}>A bathroom renovation is the most trade-intensive job in a home. It requires a tiler, plumber, electrician and often a carpenter — all of whom need to coordinate their work in a specific sequence. The most common cause of budget blowouts is not the individual trade costs but poor coordination and undiscovered problems (rotted substrate, inadequate waterproofing, hidden pipe work) revealed during demolition. A detailed scope agreement before work starts is not optional — it is the only protection you have against mid-job price increases.</p>
        </div>

        <div style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'14px', overflow:'hidden', marginBottom:'20px' }}>
          <div style={{ background:'rgba(107,79,168,0.08)', borderBottom:'1px solid rgba(107,79,168,0.2)', padding:'14px 20px' }}><p style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'12px', color:'#6B4FA8', letterSpacing:'0.5px', margin:0 }}>TYPICAL PRICE RANGES — PERTH METRO 2025</p></div>
          <div style={{ padding:'16px 20px', display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(200px, 1fr))', gap:'12px' }}>
            {[
              ...
              { item:'Tiling (labour)', range:'$2,500–$6,000', note:'Floor and walls, standard bathroom' },
        ...
        <div style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'14px', overflow:'hidden', marginBottom:'20px' }}>
          ...
          <div style={{ padding:'20px', display:'flex', flexDirection:'column' as const, gap:'14px' }}>
            {[
              { factor:'What you find behind the walls', detail:'The most common bathroom renovation nightmare in Perth is discovering the original waterproofing — or lack of it — once demolition begins. Homes built between 1960 and 1995 in suburbs like Noranda, Balga, Girrawheen, Thornlie and Gosnells often have no waterproofing membrane at all, or have the old-style tar-based membrane that is long degraded. When this is found, the scope expands — more substrate repair, proper membrane application and re-tiling. The only way to protect yourself is to include a provisional sum for substrate repair in the scope agreement before work starts.' },
              { factor:'Trade sequencing in Perth\'s hot climate', detail:'In Perth summer, bathroom renovations face a specific challenge: waterproofing membranes and adhesives have minimum and maximum temperature application ranges. Attempting to tile too soon after waterproofing in 38°C heat, or in a room that heats to 45°C during the day, leads to adhesion failures. Professional tilers in Perth schedule bathroom work to avoid peak heat — typically scheduling substrate and waterproofing work for early morning and avoiding tiling in direct afternoon sun.' },
              { factor:'Layout changes multiply cost', detail:'Moving the toilet, shower or bath location requires relocating plumbing waste lines — in a slab home, this means cutting and re-routing concrete. This alone can add $2,000–$5,000 to a bathroom renovation in Perth\'s slab-dominant housing stock. Budget carefully for any layout changes and always get a plumber\'s assessment before committing to a design that moves fixtures.' },
              { factor:'Fixture and tile quality variance', detail:'The same bathroom renovation can vary by $8,000–$15,000 based purely on fixture and tile selection. A Reece or Tradelink mid-range package costs $3,000–$5,000 in fixtures. The equivalent from Astra Walker, Brodware or imported European brands runs $8,000–$20,000. The labour to install them is identical. Be clear with yourself about your budget for the products before you go to the consult.' },
            ].map(f => (
        ...
        <div style={{ background:'rgba(46,106,143,0.06)', border:'1px solid rgba(46,106,143,0.2)', borderRadius:'12px', padding:'18px 20px', marginBottom:'20px' }}>
          <p style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'12px', color:'#2E6A8F', letterSpacing:'0.5px', margin:'0 0 10px' }}>WA LICENSING & COMPLIANCE</p>
          <p style={{ fontSize:'13px', color:'#4A5E64', lineHeight:'1.7', margin:'0 0 10px' }}>A bathroom renovation involves multiple licensed trades. The plumber must hold a WA Plumbing Contractor Licence and issue a Form 5 Certificate of Compliance. The electrician must hold a WA Electrical Contractor Licence and issue a Certificate of Compliance. Waterproofing must comply with AS 3740. If the renovation is part of a larger building project, a Building Permit may be required from your local council.</p>
          <p style={{ fontSize:'13px', color:'#4A5E64', lineHeight:'1.7', margin:0 }}>Using a bathroom renovation company that coordinates all trades under one contract simplifies compliance management but adds a margin. Using separate trades gives you more control but requires you to coordinate sequencing. Steadyhand is designed for the latter — each trade can have their own scope agreement within the same job record.</p>
        </div>
        ...
        <div style={{ background:'#E8F0EE', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'14px', overflow:'hidden', marginBottom:'20px' }}>
          ...
          <div style={{ padding:'16px 20px' }}>
            {['What provisional sum do you include for substrate repair on demolition?','Does the quote include waterproofing — which product and to which standard?','Who manages trade sequencing — and what is the schedule?','Will the plumber provide a Form 5 and the electrician a Certificate of Compliance?','What happens to the price if we find degraded substrate or missing waterproofing?','Can I see examples of your previous bathroom work in Perth homes of similar age?','What is the payment schedule — are milestones tied to defined completion stages?','Is the layout change feasible without cutting the slab, and have you confirmed with a plumber?'].map((q,i) => (
        ...
        <div style={{ background:'rgba(212,82,42,0.05)', border:'1px solid rgba(212,82,42,0.2)', borderRadius:'12px', padding:'18px 20px', marginBottom:'28px' }}>
          ...
          {['No provisional sum for unexpected substrate damage — this is the most common cause of blowouts','Waterproofing not explicitly included or described','No mention of compliance certificates from plumber and electrician','Payment structure front-loaded — more than 10% upfront or large payments before milestones are complete','Scope that does not specify fixture brands or allowances — leaves you exposed to substitution'].map((f,i) => (
        ...
        <div style={{ marginTop:'24px' }}>
          ...
          <div style={{ display:'flex', gap:'8px', flexWrap:'wrap' as const }}>
            {[{href:'/guides/tiling',label:'Tiling'},{href:'/guides/plumbing',label:'Plumbing & gas'},{href:'/guides/electrical',label:'Electrical'}].map(l => (
