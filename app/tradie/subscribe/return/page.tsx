      ...
      <div style={{ background:'#E8F0EE', borderRadius:'20px', padding:'40px 36px', maxWidth:'480px', width:'100%', textAlign:'center' as const, boxShadow:'0 16px 48px rgba(28,43,50,0.12)' }}>
        ...
        {status === 'success' && (
          <>
            ...
            <h1 style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'22px', color:'#1C2B32', letterSpacing:'0.5px', marginBottom:'10px' }}>You're subscribed</h1>
            ...
            <a href="/tradie/dashboard" style={{ display:'block', background:'#1C2B32', color:'white', padding:'14px', borderRadius:'10px', fontSize:'14px', fontWeight:600, textDecoration:'none' }}>
              Go to dashboard →
            </a>
          </>
        )}
