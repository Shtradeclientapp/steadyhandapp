  ...
  return (
    <div style={{minHeight:'100vh',background:'#C8D5D2',color:'#1C2B32',fontFamily:'Georgia,serif'}}>
      ...
      <div style={{borderTop:'1px solid rgba(28,43,50,0.12)',padding:'28px 24px',textAlign:'center' as const}}>
        <p style={{fontSize:'12px',color:'rgba(28,43,50,0.35)',margin:0}}>Steadyhand Digital · Australia · <a href="mailto:info@steadyhanddigital.com" style={{color:'rgba(216,228,225,0.25)',textDecoration:'none'}}>info@steadyhanddigital.com</a></p>
      </div>
    </div>
  )
}
