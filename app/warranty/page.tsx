    ...
    <div style={{ minHeight:'calc(100vh - 64px)', background:'#C8D5D2', padding:'40px 24px' }}>
      ...
      {job && (
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap' as const, padding:'12px 16px', background:'#F4F8F7', borderTop:'1px solid rgba(28,43,50,0.08)' }}>
          ...
          <a href={`/api/pdf/generate/warranty?job_id=${job.id}`} target="_blank" rel="noopener noreferrer" style={{ fontSize:'11px', color:'#4A5E64', textDecoration:'none', padding:'4px 10px', background:'white', border:'1px solid rgba(28,43,50,0.1)', borderRadius:'6px' }}>↓ Warranty certificate</a>
