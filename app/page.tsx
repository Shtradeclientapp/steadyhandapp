    ...
    <div style={{ minHeight:'100vh', background:'#C8D5D2', fontFamily:'sans-serif' }}>
      ...
      <div style={{ background:'#1C2B32', position:'relative', overflow:'hidden', textAlign:'center' }}>
        ...
        <div className="hero-inner" style={{ position:'relative', zIndex:1 }}>
          ...
          <h1 className="hero-title" style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'clamp(32px, 6vw, 72px)', color:'rgba(216,228,225,0.92)', letterSpacing:'3px', lineHeight:'1.1', marginBottom:'24px', maxWidth:'720px', margin:'0 auto 24px' }}>
            BUILDING CONNECTED<br />DIGITAL & TRADE<br />CAPABILITIES
          </h1>
          <p className="hero-sub" style={{ fontSize:'18px', fontWeight:'300', color:'rgba(216,228,225,0.6)', lineHeight:'1.7', maxWidth:'520px', margin:'0 auto 40px' }}>
      ...
      <div style={{ background:'#1C2B32' }}>
        <div className="testimonial-inner">
          ...
          <blockquote className="testimonial-quote" style={{ fontSize:'20px', fontStyle:'italic', fontWeight:'300', color:'rgba(216,228,225,0.85)', lineHeight:'1.7', marginBottom:'24px' }}>
      ...
      <div className="cta-inner">
        <h2 className="cta-title" style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'28px', color:'#1C2B32', letterSpacing:'1.5px', marginBottom:'12px' }}>BUILT FOR WA. BUILT FOR TRUST.</h2>
