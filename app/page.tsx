    ...
    <div style={{ minHeight:'100vh', background:'#C8D5D2', fontFamily:'sans-serif' }}>
      ...
      <nav style={{ background:'rgba(200,213,210,0.95)', borderBottom:'1px solid rgba(28,43,50,0.1)', position:'sticky', top:0, zIndex:100 }}>
        <div className="nav-inner">
          ...
          <div style={{ display:'flex', gap:'10px' }}>
            <Link href="/login"><button style={{ background:'transparent', border:'1px solid rgba(28,43,50,0.25)', color:'#1C2B32', padding:'8px 18px', borderRadius:'6px', fontSize:'13px', cursor:'pointer' }}>Log in</button></Link>
            <Link href="/signup"><button style={{ background:'#1C2B32', color:'white', padding:'8px 18px', borderRadius:'6px', fontSize:'13px', cursor:'pointer', border:'none' }}>Get started</button></Link>
          </div>
        </div>
      </nav>
      ...
      <div style={{ background:'#1C2B32', position:'relative', overflow:'hidden', textAlign:'center' }}>
        ...
        <div className="hero-inner" style={{ position:'relative', zIndex:1 }}>
          ...
          <h1 style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'clamp(28px, 5vw, 64px)', color:'rgba(216,228,225,0.92)', letterSpacing:'3px', lineHeight:'1.1', maxWidth:'780px', margin:'0 auto 24px' }}>
          ...
          <p style={{ fontSize:'18px', fontWeight:'400', color:'rgba(216,228,225,0.8)', lineHeight:'1.7', maxWidth:'560px', margin:'0 auto 40px' }}>
            Steadyhand stays with you through every stage &mdash; so you always know what to do next.
          </p>
          <div style={{ display:'flex', gap:'14px', justifyContent:'center', flexWrap:'wrap' }}>
            ...
            <Link href="/signup"><button style={{ background:'transparent', color:'rgba(216,228,225,0.8)', padding:'14px 32px', borderRadius:'8px', fontSize:'15px', border:'1px solid rgba(216,228,225,0.2)', cursor:'pointer' }}>Get started as a tradie</button></Link>
          </div>
        </div>
      </div>
        ...
        <div className="stats-bar stats-inner">
          {[
            ...
            <div key={s.label} style={{ textAlign:'center' }}>
              <div style={{ fontFamily:'var(--font-aboreto), sans-serif', fontSize:'15px', color:'#D4522A', letterSpacing:'0.5px', marginBottom:'4px' }}>{s.num}</div>
      ...
      <div className="section-inner" id="for-homeowners">
        ...
        <div className="values-grid">
          {[
            { icon:"😟", title:"You don't know if the quote is fair", body:"You've received multiple quotes with different line items and assumptions. You can't tell if you're being overcharged or if the cheapest one is cutting corners. Steadyhand shows you quotes side by side and tells you what to look for." },
            { icon:"📄", title:"You don't know what you're signing", body:"The contract is full of legal language and exclusions you don't understand. Steadyhand uses plain language and makes sure every inclusion, exclusion and milestone is agreed before work starts." },
            { icon:"🔧", title:"You can't tell if the work is on track", body:"The tradie says everything is fine but you're not sure what's happening on site. Steadyhand gives you milestone-by-milestone visibility — you approve each stage before payment releases." },
            { icon:"🛡", title:"You don't know what to do if something goes wrong", body:"The job is done but there's a problem. Steadyhand's warranty period means issues are tracked, deadlines are set, and you have a complete documented record to stand on." },
          ].map(v => (
        ...
        <div className="section-inner">
          ...
          <div className="steps-grid">
            {[
              ...
              { num:"04", title:"Compare", body:"See all quotes side by side — line items, start dates, conditions. We highlight what to watch out for." },
              { num:"05", title:"Contract", body:"Review the scope in plain language. Every inclusion and exclusion is spelled out. You sign when you are confident. Nothing starts until you do." },
              { num:"06", title:"Build", body:"Work happens in stages. You approve each milestone before payment releases. You are never releasing money for work you have not seen." },
      ...
      <div className="section-inner">
        ...
        <p style={{ fontSize:'16px', color:'#4A5E64', fontWeight:'300', lineHeight:'1.7', maxWidth:'580px', marginBottom:'48px' }}>
          Every other trades platform was built for tradies &mdash; to help them find more leads. Steadyhand was built for the person on the other side of the contract. The one who does not speak the language, does not know the going rate, and just wants the job done right.
        </p>
        <div className="values-grid">
          {[
            { icon:"💬", title:"Dialogue, not just documents", body:"The trust between a client and tradie is built through conversation. Steadyhand scores every job dialogue across six dimensions — pricing transparency, compliance, risk and timeline. Good conversations lead to good outcomes." },
            { icon:"🔍", title:"Verified, not just listed", body:"Every tradie on Steadyhand has had their licence and insurance checked before they appear in any shortlist. Verification is not a badge you buy — it is a condition of being here." },
            { icon:"⚖️", title:"We only earn when you do", body:"Steadyhand charges a small completion fee only when a job is finished and approved. We have no incentive to fill your shortlist with paid listings or rush you through a quote." },
      ...
      <div style={{ background:'#1C2B32' }} id="for-trade-businesses">
        <div className="section-inner">
          ...
          <p style={{ fontSize:'16px', color:'rgba(216,228,225,0.5)', fontWeight:'300', lineHeight:'1.7', maxWidth:'560px', marginBottom:'40px' }}>
            Steadyhand attracts clients who are serious about doing things properly. They have read the scope. They know what they are paying for. They have agreed to the milestones. That means fewer disputes, faster payments, and work that is worth doing.
          </p>
          <div className="steps-grid">
            {[
              ...
              { title:"Scope agreements that protect you too", body:"The signed scope agreement protects you from scope creep, unpaid variations, and disputes over what was agreed. It is stored permanently against every job." },
      ...
      <div style={{ background:'#1C2B32' }}>
        <div className="cta-inner">
          ...
          <p style={{ fontSize:'16px', color:'rgba(216,228,225,0.5)', fontWeight:'300', maxWidth:'480px', margin:'0 auto 32px', lineHeight:'1.7' }}>
            Steadyhand is free to start. No subscription, no lead fees. You only pay a small completion fee when the job is done and you are satisfied.
          </p>
          <div className="cta-buttons">
            <Link href="/signup"><button style={{ background:'#D4522A', color:'white', padding:'14px 32px', borderRadius:'8px', fontSize:'15px', fontWeight:'500', border:'none', cursor:'pointer' }}>Start a job request &mdash; it&apos;s free</button></Link>
            <Link href="/signup"><button style={{ background:'transparent', color:'rgba(216,228,225,0.8)', padding:'14px 32px', borderRadius:'8px', fontSize:'15px', border:'1px solid rgba(216,228,225,0.2)', cursor:'pointer' }}>Join as a trade business</button></Link>
          </div>
        </div>
      </div>
